...
-- Dumping data for table jaruratbazaardb.auth_permission: ~18 rows (approximately)
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$100000$H8yKIu51aRXK$tUVO/aXWkXjYyUufNgvAeEJhbnf/YSClhg9/oLLCqSY=', '2019-10-02 00:35:21', 1, 'jaruratbazaar', '', '', 'jaruratbazaar@gmail.com', 1, 1, '2019-10-02 00:34:17');
...
-- Dumping data for table jaruratbazaardb.django_admin_log: ~0 rows (approximately)
...
-- Dumping data for table jaruratbazaardb.django_content_type: ~6 rows (approximately)
...
-- Dumping data for table jaruratbazaardb.django_migrations: ~14 rows (approximately)
...
-- Dumping data for table jaruratbazaardb.django_session: ~0 rows (approximately)
